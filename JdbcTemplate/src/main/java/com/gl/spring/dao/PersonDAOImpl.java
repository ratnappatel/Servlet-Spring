...
import com.gl.model.PersonMapper;
...
public class PersonDAOImpl implements PersonDAO {
	...
	public Person getPersonById(Long id) {
		...
		return jdbcTemplate.queryForObject(SQL_FIND_PERSON, new Object[] { id },
				new PersonMapper());
	}
	...
	public boolean updatePerson(Person person) {
		return jdbcTemplate.update(SQL_UPDATE_PERSON, person.getFirstName(), 
				person.getLastName(), person.getAge(),
				person.getId()) > 0;
	}

	public boolean createPerson(Person person) {
		return jdbcTemplate.update(SQL_INSERT_PERSON, person.getId(), 
